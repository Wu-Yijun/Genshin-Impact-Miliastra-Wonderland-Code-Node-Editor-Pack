 ...
 *
 * @version 1.1.0
 * @date Sun Nov 23 2025 10:56:34 GMT+0800 (中国标准时间)
 * @author Aluria
 * 
...
export const NodeId = {
  Unknown: 0,
  Generic: 475,
  Comparison_Operators: 476,
  Logical_Operators: 477,
  Mathematical_Operators: 478,
  Attack_Shapes: 479,
  Survival_Status: 480,
  Sorting_Rules: 481,
  Rounding_Logic: 482,
  Type_Conversions: 483,
  Motion_Path_Point_Types: 484,
  Motion_Types: 485,
  Follow_Location_Type: 486,
  Coordinate_System_Type: 487,
  Elemental_Type: 488,
  Entity_Type: 489,
  Unit_Status_Addition_Result: 491,
  Unit_Status_Removal_Reason: 492,
  Unit_Status_Removal_Strategy: 493,
  Revive_Point_Selection_Strategy: 494,
  Cause_Of_Being_Down: 495,
  Trigonometric_Functions: 496,
  Disruptor_Device_Types: 497,
  Disruptor_Device_Orientation: 498,
  UI_Control_Group_Status: 499,
  Target_Type: 500,
  Trigger_Restriction: 501,
  Hit_Type: 502,
  Attack_Type: 503,
  Hit_Performance_Level: 504,
  Skill_Slot: 3351,
  Sound_Attenuation_Mode: 3352,
  Select_Completion_Reason: 3353,
  Settlement_Status: 3354,
  Reason_For_Item_Change: 3356,
  Item_Loot_Type: 3357,
  Decision_Refresh_Mode: 3358,
  Elemental_Reaction_Type: 3359,
  Interrupt_Status: 759,
  Gameplay_Mode: 776,
  Input_Device_Type: 777,
} as const;
export type NodeId = (typeof NodeId)[keyof typeof NodeId];
export interface EnumNode {
}
export const EnumNode$ClassBase = {
  Generic: 0,
...
export type EnumNode$ClassBase = (typeof EnumNode$ClassBase)[keyof typeof EnumNode$ClassBase];
export const EnumNode$Value = {
  Default: 0,
...
export type EnumNode$Value = (typeof EnumNode$Value)[keyof typeof EnumNode$Value];
